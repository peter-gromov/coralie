	...
	else
	{
		...
		else
		{
			...
			function submitForm( val ) {
			    ...
			    var oOrderForm = $( '#ORDER_FORM' );
			 
			    $.post( '/ajax/order/index.php', oOrderForm.serialize(), function( data ) {
			...
			if( $arResult['STEP'] == 5 ) {
			    ...
			    include($_SERVER["DOCUMENT_ROOT"] . $templateFolder . "/step" . $arResult['STEP'] . ".php");
			}
