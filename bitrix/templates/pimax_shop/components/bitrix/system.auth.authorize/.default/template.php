...
<div class="login_page">
	...
	<form class="form_auth" name="form_auth" method="post" target="_top" action="<?=SITE_DIR?>auth/<?//=$arResult["AUTH_URL"]?>" class="bx_auth_form">
		...
		<input class="" type="text" name="USER_LOGIN" maxlength="255" value="<?=$arResult["LAST_LOGIN"]?>" /><br><br>
		<strong><?=GetMessage("AUTH_PASSWORD")?></strong><br>
		<input class="" type="password" name="USER_PASSWORD" maxlength="255" /><br>
		...
		<?endif?>
		<br><br>
		<input type="submit" name="Login" class="btn btn-primary" value="<?=GetMessage("AUTH_AUTHORIZE")?>" />
		<a href="?register=yes" class="btn"><?=GetMessage("PIMAX_FASHIONSTORE_ZAREGISTRIROVATQSA")?></a>
	</form>
</div>
<script type="text/javascript">
