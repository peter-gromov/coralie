...
<tfoot><tr><td colspan="2" class="subscribe-buttons">
	
	<input type="reset" class="btn" value="<?echo GetMessage("subscr_reset")?>" name="reset" />
	<input type="submit" class="btn btn-primary" name="Save" value="<?echo ($arResult["ID"] > 0? GetMessage("subscr_upd"):GetMessage("subscr_add"))?>" />
</td></tr></tfoot>
</table>
