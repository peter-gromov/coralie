	...
	<div class="bx_filter_section m4">
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
			...
			<?foreach($arResult["ITEMS"] as $key=>$arItem):
				...
				<div class="bx_filter_container sidepanel widget_pricefilter" property_id="<?php echo $key?>">
					<h3 class="bx_filter_container_title"><span class="bx_filter_container_modef"></span><?=$arItem["NAME"]?></h3>
					<div class="bx_filter_param_area">
						<div class="bx_filter_param_area_block price-filter-input-box"><div class="bx_input_container">
								<input
									class="min-price"
									type="text"
				...
				<script type="text/javascript">
					jQuery(function() {
						jQuery( "#slider-range" ).slider({
							...
							values: [ '<?echo $arItem["VALUES"]["MIN"]["HTML_VALUE"] ? $arItem["VALUES"]["MIN"]["HTML_VALUE"] : $arItem["VALUES"]["MIN"]["VALUE"]?>', '<?echo $arItem["VALUES"]["MAX"]["HTML_VALUE"] ? $arItem["VALUES"]["MAX"]["HTML_VALUE"] : $arItem["VALUES"]["MAX"]["VALUE"]?>' ],
							...
							stop: function( event, ui ) {
								...
								//goToWithPriceFilter(ui.values[ 0 ], ui.values[ 1 ])
							}
						});
					});
			...
			<?foreach($arResult["ITEMS"] as $key=>$arItem):?>
				...
				<?elseif(!empty($arItem["VALUES"]) && !isset($arItem["PRICE"])):?>
					...
					<div class="bx_filter_container sidepanel widget_brands" property_id="<?php echo $key?>">
						<h3 class="bx_filter_container_title"><span class="bx_filter_container_modef"></span><?=$arItem["NAME"]?></h3>
