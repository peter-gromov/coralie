...
?>
	<form method="post" action="<?=$arResult["AUTH_FORM"]?>" name="bform">
		...
		<input type="text" name="USER_LOGIN" maxlength="50" value="<?=$arResult["LAST_LOGIN"]?>" class="" /><br />

		<strong><span class="starrequired">*</span><?=GetMessage("AUTH_CHECKWORD")?></strong><br />
		<input type="text" name="USER_CHECKWORD" maxlength="50" value="<?=$arResult["USER_CHECKWORD"]?>" class="" /><br />
		...
		<input type="submit" class="btn btn-primary" name="change_pwd" value="<?=GetMessage("AUTH_CHANGE")?>" class="big bt_blue"/>
