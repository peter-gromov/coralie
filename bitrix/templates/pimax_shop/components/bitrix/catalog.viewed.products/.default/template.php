		...
		<div class="col-lg-3 col-md-3 col-sm-4 col-xs-6 col-ss-12 padbot40">
			<div class="tovar_item">
				...
				<div class="tovar_description clearfix">
					...
					<span class="tovar_price <?php if ($minPrice['VALUE'] > $minPrice['DISCOUNT_VALUE']):?>tovar_price_red<?php endif;?>"><?php
						...
						<?php if ($minPrice['VALUE'] > $minPrice['DISCOUNT_VALUE']):?><span class="tovar_price tovar_price_old"><?php echo $minPrice['PRINT_VALUE']?></span><?php endif;?>
