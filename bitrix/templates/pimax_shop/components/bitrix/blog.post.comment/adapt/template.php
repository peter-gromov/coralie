	...
	else
	{
			...
			<div id="form_comment_" style="display:none;">
				...
				<div class="blog-comment-fields">
					...
					<div class="blog-comment-buttons">
						<input class="btn btn-primary" tabindex="10" value="<?=GetMessage("B_B_MS_SEND")?>" type="button" name="sub-post" id="post-button" onclick="submitComment()">
					</div>
				</div>
		...
		if($arResult["is_ajax_post"] != "Y")
		{
			if($arResult["CanUserComment"])
			{
				...
				?>
				<div class="blog-add-comment"><a class="bx_medium bx_bt_button"><b><?=GetMessage("B_B_MS_ADD_COMMENT")?></b></a><br /></div>
				<a name="0"></a>
				<?
