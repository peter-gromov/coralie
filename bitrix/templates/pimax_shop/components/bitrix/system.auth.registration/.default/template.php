...
?>
	...
	<noindex>
	<form class="register_form" method="post" action="<?=$arResult["AUTH_URL"]?>" name="bform">
		...
		<input type="text" name="USER_NAME" maxlength="50" value="<?=$arResult["USER_NAME"]?>" class="" /><br />

		<strong><?=GetMessage("AUTH_LAST_NAME")?></strong><br />
		<input type="text" name="USER_LAST_NAME" maxlength="50" value="<?=$arResult["USER_LAST_NAME"]?>" class="" /><br />

		<strong><span class="starrequired">*</span><?=GetMessage("AUTH_LOGIN_MIN")?></strong><br />
		<input type="text" name="USER_LOGIN" maxlength="50" value="<?=$arResult["USER_LOGIN"]?>" class="" /><br />

		<strong><span class="starrequired">*</span><?=GetMessage("AUTH_PASSWORD_REQ")?></strong><br />
		<input type="password" name="USER_PASSWORD" maxlength="50" value="<?=$arResult["USER_PASSWORD"]?>" class="" /><br />

		<strong><span class="starrequired">*</span><?=GetMessage("AUTH_CONFIRM")?></strong><br />
		<input type="password" name="USER_CONFIRM_PASSWORD" maxlength="50" value="<?=$arResult["USER_CONFIRM_PASSWORD"]?>" class="" /><br />

		<strong><span class="starrequired">*</span><?=GetMessage("AUTH_EMAIL")?></strong><br />
		<input type="text" name="USER_EMAIL" maxlength="255" value="<?=$arResult["USER_EMAIL"]?>" class="" /><br />
		...
		<?if ($arResult["USE_CAPTCHA"] == "Y"):?>
			...
			<input type="text" name="captcha_word" maxlength="50" value="" class="" /><br />
		<?endif?>
		<!-- /CAPTCHA -->

		<input type="submit" class="btn btn-primary" name="Register" value="<?=GetMessage("AUTH_REGISTER")?>" class="bt_blue big shadow" />
