...
<div class="bx_order_list">
	...
	<?else:?>
		...
		<table class="bx_order_list_table shop_table">
			<thead>
				<tr>
					<th colspan="2"><?=GetMessage('SPOD_ORDER')?> <?=GetMessage('SPOD_NUM_SIGN')?><?=$arResult["ACCOUNT_NUMBER"]?> <?=GetMessage("SPOD_FROM")?> <?=$arResult["DATE_INSERT_FORMATED"]?></th>
				</tr>
			</thead>
			<tbody>
				<tr>
		...
		<table class="bx_order_list_table_order shop_table">
			<thead>
				<tr>			
		...
		<table class="bx_control_table" style="width: 100%;">
			<tr>
				<td>  <a href="<?=$arResult["URL_TO_LIST"]?>" class="btn"><?=GetMessage('SPOD_GO_BACK')?></a></td>
			</tr>
		</table>
