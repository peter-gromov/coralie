...
$MESS["PIMAX_FASHIONSTORE_BYSTRYY_PROSMOTR"] = "Быстрый просмотр";
$MESS["PIMAX_FASHIONSTORE_ZAKRYTQ"] = "Закрыть";
$MESS["PIMAX_FASHIONSTORE_V_KORZINU"] = "В корзину";
$MESS["PIMAX_FASHIONSTORE_PODELITQSA_S_DRUZQAM"] = "Поделиться с друзьями";
?>