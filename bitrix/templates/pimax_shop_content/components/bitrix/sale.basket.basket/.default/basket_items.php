...
<div id="basket_items_list">
	<div class="bx_ordercart_order_table_container">
		<table id="basket_items" class="shop_table">
			<thead>
				<tr>
					<th class="margin"></th>
					<?
					foreach ($arResult["GRID"]["HEADERS"] as $id => $arHeader):
						...
						if ($arHeader["id"] == "NAME"):
						?>
							<th class="product-name" colspan="2" id="col_<?=getColumnId($arHeader)?>">
						<?
						elseif ($arHeader["id"] == "PRICE"):
						?>
							<th class="product-price" id="col_<?=getColumnId($arHeader)?>">
						<?
						else:
						?>
					...
					<tr class="cart_item" id="<?=$arItem["ID"]?>">
						...
						?>
							<td class="product-remove">
								...
								if ($bDeleteColumn):
								?>
								<a title="Удалить" class="tover_view_page_close" href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>"><span class="fa-product-close" aria-hidden="true"></span></a>
	...
	<div class="bx_ordercart_order_pay">
		...
		<div class="bx_ordercart_order_pay_center">
			...
			<a href="javascript:void(0)" onclick="checkOut();" class="btn active"><?=GetMessage("SALE_ORDER")?></a>
		</div>
	</div>
</div>
<?
