	...
	BX.CRM.UFMobile = (function () {
		...
		UF.prototype = {
			entities : {
				lead : {
					prefix : "L_",
					viewUrl : "/mobile/crm/lead/view.php?lead_id=#id#",
					selectUrl : "/mobile/crm/search.php?entity=lead"
				},
				contact : {
					prefix : "C_",
					viewUrl : "/mobile/crm/contact/view.php?contact_id=#id#",
					selectUrl : "/mobile/crm/search.php?entity=contact"
				},
				company : {
					prefix : "CO_",
					viewUrl : "/mobile/crm/company/view.php?company_id=#id#",
					selectUrl : "/mobile/crm/search.php?entity=company"
				},
				deal : {
					prefix : "D_",
					viewUrl : "/mobile/crm/deal/view.php?deal_id=#id#",
					selectUrl : "/mobile/crm/search.php?entity=deal"
				},
				quote : {
					prefix : "Q_",
					viewUrl : "/mobile/crm/quote/view.php?quote_id=#id#",
