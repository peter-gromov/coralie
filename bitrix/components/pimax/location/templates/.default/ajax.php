...
<div id="pimax-location-dialog" class="tover_view_page element_fade_in">
	<div class="tover_view_header clearfix">
		<p>Выбор города</p>
		<a id="tover_view_page_close" href="javascript:void(0);"><i class="fa-product-close" aria-hidden="true"></i></a>
	</div>
...
document.getElementById('city').value = getObj('city').value;
    ...
    function Load(){
        ...
        o=getObj('info');
        o.options.length=0;
        ajaxLoad('info', '/bitrix/components/pimax/location/templates/.default/city_base.php?city_name='+ot, '','','');
