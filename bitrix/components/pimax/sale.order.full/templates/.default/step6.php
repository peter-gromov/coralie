...
<tr>
	<td valign="top" width="60%">
		...
		{
			?>
			<h3><?echo GetMessage("STOF_ORDER_CREATED")?></h3>
			...
			if (!empty($arResult["PAY_SYSTEM"]))
			{
				?>
				<br /><br />
				<h3><?echo GetMessage("STOF_ORDER_PAY_ACTION")?></h3>
				
				<?php if ($arResult['PAY_SYSTEM']['ID'] == 8):?>
					<p style="font-size: 14px"><strong>Заказ необходимо оплатить в течение суток после оформления.</strong>
							</p>
